...
def index(request):
    ...
    return render(request,"book/index.html",{'result':dept1})
def dept(request):
    dept1=department.objects.all()
    return render(request,"book/details.html",{'r':dept1})
...
def new(request):
    dept1 = department.objects.all()
    return render(request, "book/new.html",{'r1':dept1})
...
def addform(request):
    ...
    return render(request,"book/demo.html")
